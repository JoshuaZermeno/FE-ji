module Bucks
	class Api::V1::EmployeeSerializer < ActiveModel::Serializer
		attributes :id, :IDnum, :access, :first_name, :last_name, :department_id, :created_at, :updated_at, :image, :password_digest, :job_id, :email, :status, :earn, :issue, :issue_special, :balance, :reset_key, :reset_key_time, :new_pass, :rankings

		belongs_to :department, serializer: Bucks::Api::V1::DepartmentSerializer
		belongs_to :job, serializer: Bucks::Api::V1::JobSerializer
		has_many :to, serializer: Bucks::Api::V1::NotificationSerializer
